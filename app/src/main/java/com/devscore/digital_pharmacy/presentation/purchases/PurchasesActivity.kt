...
import kotlinx.android.synthetic.main.activity_sales.sales_progress_bar

@AndroidEntryPoint
class PurchasesActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun displayProgressBar(isLoading: Boolean) {
        if(isLoading){
            purchases_progress_bar.visibility = View.VISIBLE
        }
        else{
            purchases_progress_bar.visibility = View.GONE
        }
    }
...
//        }
    ...
    private fun setUpUI() {
        val navHostFragment =
            supportFragmentManager.findFragmentById(R.id.purchases_fragment_container) as NavHostFragment
